...
export const MissionTimer = () => {
  ...
  return (
    <div
      ...
      className={`rounded-xl border-2 transition-all duration-300 overflow-hidden ${isOptimal
        ...
        <div className="px-4 pb-4">
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`flex-1 py-2.5 rounded-lg font-bold text-sm flex items-center justify-center gap-2 transition-all ${isActive
